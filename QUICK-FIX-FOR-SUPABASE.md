# Quick Fix for Supabase RLS Issue

## Problem
Du får `permission denied for table groups` feil når du prøver å åpne grupper.

## Løsning
Gå til [Supabase Dashboard](https://supabase.com/dashboard) → SQL Editor og kjør denne kommandoen:
...
## Resultat
Etter å ha kjørt denne kommandoen skal appen fungere uten RLS-feil.

## Viktig
Dette oppretter **riktige RLS-policies** som gir tilgang til data, men beholder sikkerheten. Dette er en **produksjonsklar løsning**.
