...
import { Users, Crown, Calendar, DollarSign, Gift, Share2, MoreVertical, Plus } from 'lucide-react'
...
export default function GroupCard({ group, memberCount = 0, wishlistCount = 0, onClick, onShare, onAddWish }: GroupCardProps) {
  const { user } = useAuth()
      ...
      <div className="relative z-10 mb-6">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="relative">
            ...
            {showMenu && (
              <div className="absolute right-0 top-10 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-20 min-w-[160px]">
                <button
